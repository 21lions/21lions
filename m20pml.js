...
$('.simple-ticker').attr('id', 'js-ticker-fade');
 ...
 $( "div#flip" ).load( "/pml/admin .col-xl-6:nth-child(1) .card.text-center.card-default .card-body h4.card-title" );
 $( "div#mem").load( "/pml/admin ul.navbar-nav.flex-row.mr-3 " );

/*league leaders home page********/
$( ".passingleaders" ).load( "/pml/stats/player/passing  .col-xl-10" );
$( ".rushingleaders" ).load( "/pml/stats/player/rushing .col-xl-10" );
$( ".receivingleaders" ).load( "/pml/stats/player/receiving .col-xl-10" );
$( ".sacksleaders" ).load( "/pml/stats/player/defense?sortby=sack  .col-xl-10" );
$( ".tacklesleaders" ).load( "/pml/stats/player/defense?sortby=tackles .col-xl-10" );
$( ".interceptionsleaders" ).load( "/pml/stats/player/defense?sortby=int .col-xl-10" );

/*standings tabs*******************************************************/
 $( ".afc.standings").load( "/pml/standings .card.card-default:nth-child(4)" );
 $( ".nfc.standings").load( "/pml/standings .card.card-default:nth-child(5)" );

/*All Teams Page**********************************************************/
if(window.location.href=== "http://www.daddyleagues.com/pml/teams") {
         $(".col-xl-10").addClass("teams");
     }

/*Standings Page*********************************************************/
if(window.location.href=== "/pml/standings") {
...
/*storylines***/
 $( ".jumbotron.hero-nature.carousel-hero" ).load( "/pml/blog .blogpost:nth-child(1)" );
 $( ".jumbotron.hero-photography.carousel-hero" ).load( "/pml/blog .blogpost:nth-child(2)" );
 $( ".jumbotron.hero-technology.carousel-hero" ).load( "/pml/blog .blogpost:nth-child(3)" );
