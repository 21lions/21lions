...
$('.simple-ticker').attr('id', 'js-ticker-fade');
 ...
 $( "div#flip" ).load( "/sml/admin .col-xl-6:nth-child(1) .card.text-center.card-default .card-body h4.card-title" );
 $( "div#mem").load( "/sml/admin ul.navbar-nav.flex-row.mr-3 " );

/*league leaders home page********/
$( ".passingleaders" ).load( "/sml/stats/player/passing  .col-xl-10" );
$( ".rushingleaders" ).load( "/sml/stats/player/rushing .col-xl-10" );
$( ".receivingleaders" ).load( "/sml/stats/player/receiving .col-xl-10" );
$( ".sacksleaders" ).load( "/sml/stats/player/defense?sortby=sack  .col-xl-10" );
$( ".tacklesleaders" ).load( "/sml/stats/player/defense?sortby=tackles .col-xl-10" );
$( ".interceptionsleaders" ).load( "/sml/stats/player/defense?sortby=int .col-xl-10" );

/*standings tabs*******************************************************/
 $( ".afc.standings").load( "/sml/standings .card.card-default:nth-child(4)" );
 $( ".nfc.standings").load( "/sml/standings .card.card-default:nth-child(5)" );

/*All Teams Page**********************************************************/
if(window.location.href=== "http://www.daddyleagues.com/sml/teams") {
         $(".col-xl-10").addClass("teams");
     }

/*Standings Page*********************************************************/
if(window.location.href=== "/sml/standings") {
...
/*storylines***/
 $( ".jumbotron.hero-nature.carousel-hero" ).load( "/sml/blog .blogpost:nth-child(1)" );
 $( ".jumbotron.hero-photography.carousel-hero" ).load( "/sml/blog .blogpost:nth-child(2)" );
 $( ".jumbotron.hero-technology.carousel-hero" ).load( "/sml/blog .blogpost:nth-child(3)" );
