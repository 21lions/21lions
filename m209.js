...
/*storylines***/
 $( ".jumbotron.hero-nature.carousel-hero" ).load( "/Heavyhitters/blog .blogpost:nth-child(1)" );
 $( ".jumbotron.hero-photography.carousel-hero" ).load( "/Heavyhitters/blog .blogpost:nth-child(2)" );
 $( ".jumbotron.hero-technology.carousel-hero" ).load( "/Heavyhitters/blog .blogpost:nth-child(3)" );
