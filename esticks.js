...
$('.simple-ticker').attr('id', 'js-ticker-fade');
 ...
 $( "div#flip" ).load( "/4TH/admin .col-xl-6:nth-child(1) .card.text-center.card-default .card-body h4.card-title" );
 $( "div#mem").load( "/4TH/admin ul.navbar-nav.flex-row.mr-3 " );

/*league leaders home page********/
$( ".passingleaders" ).load( "/4TH/stats/player/passing  .col-xl-10" );
$( ".rushingleaders" ).load( "/4TH/stats/player/rushing .col-xl-10" );
$( ".receivingleaders" ).load( "/4TH/stats/player/receiving .col-xl-10" );
$( ".sacksleaders" ).load( "/4TH/stats/player/defense?sortby=sack  .col-xl-10" );
$( ".tacklesleaders" ).load( "/4TH/stats/player/defense?sortby=tackles .col-xl-10" );
$( ".interceptionsleaders" ).load( "/4TH/stats/player/defense?sortby=int .col-xl-10" );

/*standings tabs*******************************************************/
 $( ".afc.standings").load( "/4TH/standings .card.card-default:nth-child(4)" );
 $( ".nfc.standings").load( "/4TH/standings .card.card-default:nth-child(5)" );

/*All Teams Page**********************************************************/
if(window.location.href=== "http://www.daddyleagues.com/4TH/teams") {
         $(".col-xl-10").addClass("teams");
     }

/*Standings Page*********************************************************/
if(window.location.href=== "/4TH/standings") {
...
/*storylines***/
 $( ".jumbotron.hero-nature.carousel-hero" ).load( "/4TH/blog .blogpost:nth-child(1)" );
 $( ".jumbotron.hero-photography.carousel-hero" ).load( "/4TH/blog .blogpost:nth-child(2)" );
 $( ".jumbotron.hero-technology.carousel-hero" ).load( "/4TH/blog .blogpost:nth-child(3)" );
