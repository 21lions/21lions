...
$('.simple-ticker').attr('id', 'js-ticker-fade');
 ...
 $( "div#flip" ).load( "/HML/admin .col-xl-6:nth-child(1) .card.text-center.card-default .card-body h4.card-title" );
 $( "div#mem").load( "/HML/admin ul.navbar-nav.flex-row.mr-3 " );

/*league leaders home page********/
$( ".passingleaders" ).load( "/HML/stats/player/passing  .col-xl-10" );
$( ".rushingleaders" ).load( "/HML/stats/player/rushing .col-xl-10" );
$( ".receivingleaders" ).load( "/HML/stats/player/receiving .col-xl-10" );
$( ".sacksleaders" ).load( "/HML/stats/player/defense?sortby=sack  .col-xl-10" );
$( ".tacklesleaders" ).load( "/HML/stats/player/defense?sortby=tackles .col-xl-10" );
$( ".interceptionsleaders" ).load( "/HML/stats/player/defense?sortby=int .col-xl-10" );

/*standings tabs*******************************************************/
 $( ".afc.standings").load( "/HML/standings .card.card-default:nth-child(4)" );
 $( ".nfc.standings").load( "/HML/standings .card.card-default:nth-child(5)" );

/*All Teams Page**********************************************************/
if(window.location.href=== "http://www.daddyleagues.com/HML/teams") {
         $(".col-xl-10").addClass("teams");
     }

/*Standings Page*********************************************************/
if(window.location.href=== "/HML/standings") {
