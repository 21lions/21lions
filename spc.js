...
/***scoreboard**********************/
 $( "div#flip2").load( "/SPC/schedules div#scores" );
...
$('.simple-ticker').attr('id', 'js-ticker-fade');
 ...
 $( "div#flip" ).load( "/SPC/admin .col-xl-6:nth-child(1) .card.text-center.card-default .card-body h4.card-title" );
 $( "div#mem").load( "/SPC/admin ul.navbar-nav.flex-row.mr-3 " );

/*league leaders home page********/
$( ".passingleaders" ).load( "/SPC/stats/player/passing  .col-xl-10" );
$( ".rushingleaders" ).load( "/SPC/stats/player/rushing .col-xl-10" );
$( ".receivingleaders" ).load( "/SPC/stats/player/receiving .col-xl-10" );
$( ".sacksleaders" ).load( "/SPC/stats/player/defense?sortby=sack  .col-xl-10" );
$( ".tacklesleaders" ).load( "/SPC/stats/player/defense?sortby=tackles .col-xl-10" );
$( ".interceptionsleaders" ).load( "/SPC/stats/player/defense?sortby=int .col-xl-10" );

/*standings tabs*******************************************************/
 $( ".afc.standings").load( "/SPC/standings .card.card-default:nth-child(4)" );
 $( ".nfc.standings").load( "/SPC/standings .card.card-default:nth-child(5)" );

/*All Teams Page**********************************************************/
if(window.location.href=== "http://www.daddyleagues.com/SPC/teams") {
         $(".col-xl-10").addClass("teams");
     }

/*Standings Page*********************************************************/
if(window.location.href=== "/SPC/standings") {
