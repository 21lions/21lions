...
$('.simple-ticker').attr('id', 'js-ticker-fade');
 ...
 $( "div#flip" ).load( "/WW3/admin .col-xl-6:nth-child(1) .card.text-center.card-default .card-body h4.card-title" );
 $( "div#mem").load( "/WW3/admin ul.navbar-nav.flex-row.mr-3 " );

/*league leaders home page********/
$( ".passingleaders" ).load( "/WW3/stats/player/passing  .col-xl-10" );
$( ".rushingleaders" ).load( "/WW3/stats/player/rushing .col-xl-10" );
$( ".receivingleaders" ).load( "/WW3/stats/player/receiving .col-xl-10" );
$( ".sacksleaders" ).load( "/WW3/stats/player/defense?sortby=sack  .col-xl-10" );
$( ".tacklesleaders" ).load( "/WW3/stats/player/defense?sortby=tackles .col-xl-10" );
$( ".interceptionsleaders" ).load( "/WW3/stats/player/defense?sortby=int .col-xl-10" );

/*standings tabs*******************************************************/
 $( ".afc.standings").load( "/WW3/standings .card.card-default:nth-child(4)" );
 $( ".nfc.standings").load( "/WW3/standings .card.card-default:nth-child(5)" );

/*All Teams Page**********************************************************/
if(window.location.href=== "http://www.daddyleagues.com/WW3/teams") {
         $(".col-xl-10").addClass("teams");
     }

/*Standings Page*********************************************************/
if(window.location.href=== "/WW3/standings") {
...
/*PANTHERS*/
	$('.col-6.bg-inverse.d-flex.align-items-center.justify-content-center.rounded-right[style*="/img/nfl/teams/right/20.png"]').attr( "style", "" ).css( 'background-image', 'url("https://i.imgur.com/mbMWd1p.png")').wrapInner( "<div id='host'><p>Username</p><p>St. Louis</p><p>Panthers</p></div>");
	$('.col-6.d-flex.align-items-center.justify-content-center.rounded-left[style*="/img/nfl/teams/left/20.png"]').attr( "style", "" ).css( 'background-image', 'url("http://i.nflcdn.com/static/site/6.3/img/logos/svg/teams/CAR.svg")').wrapInner( "<div id='visitor'><p>Username</p><p>St. Louis</p><p>Panthers</p></div>");
...
/*RAIDERS*/
	$('.col-6.bg-inverse.d-flex.align-items-center.justify-content-center.rounded-right[style*="/img/nfl/teams/right/22.png"]').attr( "style", "" ).css( 'background-image', 'url("http://i.nflcdn.com/static/site/6.3/img/logos/svg/teams/OAK.svg")').wrapInner( "<div id='host'><p>Username</p><p>Las Vegas</p><p>Raiders</p></div>");
	$('.col-6.d-flex.align-items-center.justify-content-center.rounded-left[style*="/img/nfl/teams/left/22.png"]').attr( "style", "" ).css( 'background-image', 'url("http://i.nflcdn.com/static/site/6.3/img/logos/svg/teams/OAK.svg")').wrapInner( "<div id='visitor'><p>Username</p><p>Las Vegas</p><p>Raiders</p></div>");
...
/*TITANS*/
	$('.col-6.bg-inverse.d-flex.align-items-center.justify-content-center.rounded-right[style*="/img/nfl/teams/right/29.png"]').attr( "style", "" ).css( 'background-image', 'url("https://i.imgur.com/iY9uxhq.png")').wrapInner( "<div id='host'><p>Username</p><p>London</p><p>Titans</p></div>");
	$('.col-6.d-flex.align-items-center.justify-content-center.rounded-left[style*="/img/nfl/teams/left/29.png"]').attr( "style", "" ).css( 'background-image', 'url("http://i.nflcdn.com/static/site/6.3/img/logos/svg/teams/TEN.svg")').wrapInner( "<div id='visitor'><p>Username</p><p>London</p><p>Titans</p></div>");
...
/*BAts*/
	$('.col-6.bg-inverse.d-flex.align-items-center.justify-content-center.rounded-right[style*="/img/nfl/teams/right/140.png"]').attr( "style", "" ).css( 'background-image', 'url("/img/nfl/teams/right/140.png")').wrapInner( "<div id='host'><p>Username</p><p>Austin</p><p>Bats</p></div>");
	$('.col-6.d-flex.align-items-center.justify-content-center.rounded-left[style*="/img/nfl/teams/left/140.png"]').attr( "style", "" ).css( 'background-image', 'url("/img/nfl/teams/left/140.png")').wrapInner( "<div id='visitor'><p>Username</p><p>Austin</p><p>Bats</p></div>");

/*Monarchs*/
	$('.col-6.bg-inverse.d-flex.align-items-center.justify-content-center.rounded-right[style*="/img/nfl/teams/right/167.png"]').attr( "style", "" ).css( 'background-image', 'url("/img/nfl/teams/right/167.png")').wrapInner( "<div id='host'><p>Username</p><p>London</p><p>Monarchs</p></div>");
	$('.col-6.d-flex.align-items-center.justify-content-center.rounded-left[style*="/img/nfl/teams/left/167.png"]').attr( "style", "" ).css( 'background-image', 'url("/img/nfl/teams/left/167.png")').wrapInner( "<div id='visitor'><p>Username</p><p>London</p><p>Monarchs</p></div>");


/*Blues*/
	$('.col-6.bg-inverse.d-flex.align-items-center.justify-content-center.rounded-right[style*="/img/nfl/teams/right/143.png"]').attr( "style", "" ).css( 'background-image', 'url("/img/nfl/teams/right/143.png")').wrapInner( "<div id='host'><p>Username</p><p>Chicago</p><p>Blues</p></div>");
	$('.col-6.d-flex.align-items-center.justify-content-center.rounded-left[style*="/img/nfl/teams/left/143.png"]').attr( "style", "" ).css( 'background-image', 'url("/img/nfl/teams/left/143.png")').wrapInner( "<div id='visitor'><p>Username</p><p>Chicago</p><p>Blues</p></div>");
...
/*Beats*/
	$('.col-6.bg-inverse.d-flex.align-items-center.justify-content-center.rounded-right[style*="/img/nfl/teams/right/141.png"]').attr( "style", "" ).css( 'background-image', 'url("/img/nfl/teams/right/141.png")').wrapInner( "<div id='host'><p>Username</p><p>Brooklyn</p><p>Beats</p></div>");
	$('.col-6.d-flex.align-items-center.justify-content-center.rounded-left[style*="/img/nfl/teams/left/141.png"]').attr( "style", "" ).css( 'background-image', 'url("/img/nfl/teams/left/141.png")').wrapInner( "<div id='visitor'><p>Username</p><p>Brooklyn</p><p>Beats</p></div>");
